...
export const DEFAULT_SERVICES: Service[] = [
   ...
   { id:'premium',   title:'Premium Private Tour', desc:'The ultimate luxury experience — VIP boat, champagne, and a personal guide.',                 price:'1000 DT', basePrice:1000, per:'per hour',     img:'/premuim.jpg', perPerson:false, hourly:true,  visible:true },
 ]
