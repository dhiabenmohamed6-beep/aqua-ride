    ...
    <section id="services" className="bg-[#f7f4ef] relative">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 pt-8 sm:pt-10 pb-12 sm:pb-20">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-8">
          {services.map((svc, i) => (
            <div key={svc.id || i}
              className="group bg-white rounded-[24px] sm:rounded-[32px] overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 hover:-translate-y-1 sm:hover:-translate-y-2">
              ...
              <div className="p-4 sm:p-7">
                ...
                <a href="#booking"
                  className="inline-flex items-center gap-1 sm:gap-2 bg-[#062B37] hover:bg-cyan-500 text-white font-bold px-4 sm:px-6 py-2 sm:py-3 rounded-full text-xs sm:text-sm transition-all duration-300 hover:scale-105">
