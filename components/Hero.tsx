    ...
    <section id="home" className="relative min-h-screen flex flex-col">
      ...
      <div className="relative flex-1 min-h-screen">
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 pt-48 pb-32">
          ...
          <h1 className="text-[clamp(3.5rem,9vw,8rem)] font-black text-white leading-none mb-8 anim-up"
          ...
          <div className="flex flex-wrap gap-4 anim-up" style={{ animationDelay:'.4s' }}>
            <a href="#booking"
